...
type LogType =
  ...
  | "INVENTORY_PACKAGE_CREATED"
  | "INVENTORY_PACKAGE_UPDATED"
  | "INVENTORY_PACKAGE_DELETED"
  | "INVENTORY_ITEM_CREATED"
  | "INVENTORY_ITEM_UPDATED"
  | "INVENTORY_ITEM_DELETED"
  | "INVENTORY_ITEM_UTILIZED"
  | "INVENTORY_UTILIZATION_UPDATED"
  | "INVENTORY_UTILIZATION_DELETED"
...
interface LogEntry {
  ...
  readonly inventoryPackageId: string | null
...
const TYPE_LABELS: Record<LogType, string> = {
  ...
  INVENTORY_PACKAGE_CREATED: "Inventory",
  INVENTORY_PACKAGE_UPDATED: "Inventory",
  INVENTORY_PACKAGE_DELETED: "Inventory",
  INVENTORY_ITEM_CREATED: "Inventory Item",
  INVENTORY_ITEM_UPDATED: "Inventory Item",
  INVENTORY_ITEM_DELETED: "Inventory Item",
  INVENTORY_ITEM_UTILIZED: "Utilized",
  INVENTORY_UTILIZATION_UPDATED: "Utilized",
  INVENTORY_UTILIZATION_DELETED: "Utilized",
}

const ADHOC_COLOR = "bg-orange-50 text-orange-700 border-orange-200"
const INVENTORY_COLOR = "bg-cyan-50 text-cyan-700 border-cyan-200"
...
const TYPE_COLORS: Record<LogType, string> = {
  ...
  INVENTORY_PACKAGE_CREATED: INVENTORY_COLOR,
  INVENTORY_PACKAGE_UPDATED: INVENTORY_COLOR,
  INVENTORY_PACKAGE_DELETED: INVENTORY_COLOR,
  INVENTORY_ITEM_CREATED: INVENTORY_COLOR,
  INVENTORY_ITEM_UPDATED: INVENTORY_COLOR,
  INVENTORY_ITEM_DELETED: INVENTORY_COLOR,
  INVENTORY_ITEM_UTILIZED: INVENTORY_COLOR,
  INVENTORY_UTILIZATION_UPDATED: INVENTORY_COLOR,
  INVENTORY_UTILIZATION_DELETED: INVENTORY_COLOR,
}
...
const FILTER_GROUPS = [
  ...
  { label: "Inventory", types: ["INVENTORY_PACKAGE_CREATED", "INVENTORY_PACKAGE_UPDATED", "INVENTORY_PACKAGE_DELETED", "INVENTORY_ITEM_CREATED", "INVENTORY_ITEM_UPDATED", "INVENTORY_ITEM_DELETED", "INVENTORY_ITEM_UTILIZED", "INVENTORY_UTILIZATION_UPDATED", "INVENTORY_UTILIZATION_DELETED"] as LogType[] },
