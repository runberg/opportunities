...
function TrendBarChart({ data, isEmpty, children }: {
...
export function RfqTrendChart({ data, onBarClick }: {
  ...
  return (
    <TrendBarChart data={data} isEmpty={data.every((d) => d.rfq + d.quotes === 0)}>
      <Legend
...
export function ElTrendChart({ data, onBarClick }: {
  ...
  return (
    <TrendBarChart data={data} isEmpty={data.every((d) => d.requested + d.drafted + d.signed === 0)}>
      <Legend
        iconType="circle" iconSize={8}
        wrapperStyle={{ fontSize: 11, color: "#6b7280", paddingTop: 8 }}
...
export function ProductionTrendChart({ data, onBarClick }: {
  ...
  return (
    <TrendBarChart data={data} isEmpty={data.every((d) => d.countersigned + d.advancePaid + d.fatPassed + d.delivered === 0)}>
      <Legend
        iconType="circle" iconSize={8}
        wrapperStyle={{ fontSize: 11, color: "#6b7280", paddingTop: 8 }}
